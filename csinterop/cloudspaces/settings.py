"""
Django settings for csinterop project.
...
SECRET_KEY = 'sybl!-=&c+7&!f%@c!c@yl6r)akne%)_48!rdm5f9i0r&p)4wu'
...
ROOT_URLCONF = 'cloudspaces.urls'

WSGI_APPLICATION = 'cloudspaces.wsgi.application'
